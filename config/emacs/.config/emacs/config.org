...
(global-set-key (kbd "C-c x") 'my-xref-map)

(define-key my-xref-map (kbd "d") #'xref-find-definitions)
(define-key my-xref-map (kbd "D") #'xref-find-definitions-other-window)
...
(define-key my-xref-map (kbd "n") #'xref-next-line)
(define-key my-xref-map (kbd "p") #'xref-prev-line)
(define-key my-xref-map (kbd "q") #'xref-quit-and-pop-marker-stack)
(define-key my-xref-map (kbd "l") #'xref-list-definitions)
#+END_SRC
