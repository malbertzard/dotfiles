...
#+BEGIN_SRC emacs-lisp
    (use-package flycheck
      ...
      :config
      (defvar my/flycheck-prefix-map
    	(let ((map (make-sparse-keymap)))
    	  (define-key map (kbd "j") #'flycheck-next-error)
    	  (define-key map (kbd "k") #'flycheck-previous-error)
    	  (define-key map (kbd "l") #'flycheck-list-errors)
    	  (define-key map (kbd "e") #'flycheck-explain-error-at-point)
    	  (define-key map (kbd "d") #'flycheck-display-error-at-point)
    	  map)
    	"Flycheck keymap.")

      (global-set-key (kbd "C-c e") my/flycheck-prefix-map)
      (global-set-key (kbd "C-c E") #'my/flycheck-transient)

      (require 'transient)

      (transient-define-prefix my/flycheck-transient ()
    	"Flycheck Sticky commands"
    	:transient-suffix 'transient--do-stay
    	[["Navigate"
    	  ("j" "next error" flycheck-next-error)
    	  ("k" "previous error" flycheck-previous-error)]
